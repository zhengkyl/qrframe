...
export function ButtonGroupItem(props: ItemProps) {
  return (
    <ToggleGroup.Item
      class="px-3 py-2 min-w-8 leading-tight border-l first:(border-none rounded-l-md) last:rounded-r-md text-fore-subtle aria-pressed:(bg-fore-base/10 text-fore-base) hover:bg-fore-base/10"
      value={props.value}
